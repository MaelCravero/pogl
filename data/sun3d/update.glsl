...
layout(binding = 3) buffer directionData
{
    vec3 direction[];
};
...
void main()
{
    ...
    // Arbitrary values for pseudo-randomness
    float direction_x = rand(42000) - 0.5;
    float direction_y = rand(5100) - 0.5;
    float direction_z = rand(300) - 0.5;
